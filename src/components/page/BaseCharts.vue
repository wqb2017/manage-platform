<template>
    <div>
        ...
        <div class="echarts">
            <IEcharts :option="line" :style="{width: '500px', height: '400px'}"></IEcharts>
        </div>
        <div class="echarts">
            <IEcharts :option="bar"  :style="{width: '500px', height: '400px'}"></IEcharts>
        </div>
        <div class="echarts">
            <IEcharts :option="pie"  :style="{width: '500px', height: '400px'}"></IEcharts>
        </div>
        <div class="echarts">
            <IEcharts :option="pie_radius"  :style="{width: '500px', height: '400px'}"></IEcharts>
        </div>
    </div>
</template>
